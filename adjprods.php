        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-lg-4">
                    ...
                    <input type="button" id="btn" class="btn btn-default btn-lg" style=" background: orangered" value="Update Discount">
                    <div id="tripod"></div>
                </div>
                <div id="biko" class="col-md-4 col-sm-4 col-lg-4"></div>
            </div>
