...
<html>
    ...
    <body>
        ...
        $set = "select sdate as date,productname,recno as invoiceno,qtyout,unitprice,returns, ((qtyout-returns) * unitprice) as debit,paid as credit,deposit,others as expenses,phyrec,details, 0.01 * (qtyout-returns) * unitprice * discount as discount, 0.01 * (qtyout-returns) * unitprice * pdisc as prdisc,opbal from sales where customername = '$pnamex'";
