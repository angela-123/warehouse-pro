...
<html>
    ...
    <body>
        ...
        $yey = "insert into sales(sdate,productname,customername,qtyout,unitprice,unitcost,paid,discount,staffname,recno)values(curdate(),'$product', '$customer', '$qty','$sprice','$ucost',  '$paid','$disk', '$user', '$recno')";
        ...
        $poke = "insert into audit(adate,jobtype,doneby,productname,qty,returns,rate,payment,discount,customername,invno)values(curdate(),'Sales Entry','$user','$product','$qty',0,'$sprice', '$paid','$disk', '$customer','$recno')";
...
echo '<h5 align = "center">Received above goods in good condition.No refund of money after payment </h5>';
