 ...
 $ext = $sid['extended'];
    ...
    ?>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-112">
                    <h2>OLLYTEX NIGERIA LIMITED</h2>
                    <nobr></nobr>
                    <h5>Dealers of all kinds of drinks,wine,alcoholic,beverages and provisions </h5>
            ...
            <div class="row">
                <div class=" clearfix">
                    <div class=" pull-left">
                <div class="col-md-3" id="lax">
                    Shop 087,Zuba Main Mkt<br>
                    Zuba.Abuja<br>
                    08055106444,08134876652<br>
                    07041909902,07060946803<br>
