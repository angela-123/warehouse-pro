...
<html>
  ...
  <script src="libs/jquery-1.9.0.js"></script>
    ...
    <body>
        ...
        $dex = "select pdate,suppliername,productname,qtyin,unitcost,qtyin * unitcost as amount,paid,deposit,others from purchases where MONTHNAME(pdate) = '$date' AND YEAR(pdate) = '$yr'";
